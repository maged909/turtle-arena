...
==========
*/
void CG_DrawPicFullWidth(int h480, qhandle_t hShader)
{
	...
	trap_R_DrawStretchPic( x, y, w, h * yfrac, s1, t1, s2, t2, hShader );
}
#endif
...
#ifdef IOQ3ZTM
		CG_DrawPicFullWidth( y, cgs.media.consoleShader );
#else
