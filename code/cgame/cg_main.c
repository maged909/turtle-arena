...
#ifdef TURTLEARENA
		name = Com_LocalClientCvarName(i, "cg_drawViewWeapons");
...
#ifdef IOQ3ZTM // ANALOG
		name = Com_LocalClientCvarName(i, "cg_thirdPersonAnalog");
		trap_Cvar_Register( &cg_thirdPersonAnalog[i], name, "0", 0 );
		trap_Cvar_CheckRange( name, 0, 1, qtrue );
#endif
#ifdef TURTLEARENA // FOV // THIRD_PERSON
		trap_Cvar_Register( &cg_thirdPerson[i], Com_LocalClientCvarName(i, "cg_thirdPerson"), "1", 0 );
		trap_Cvar_Register( &cg_thirdPersonRange[i], Com_LocalClientCvarName(i, "cg_thirdPersonRange"), "120", 0 );
		trap_Cvar_Register( &cg_thirdPersonAngle[i], Com_LocalClientCvarName(i, "cg_thirdPersonAngle"), "0", 0 );
#else
