...
static void UI_CreditMenu_Draw_QuitMessage( void ) {
	...
	UI_DrawProportionalString( 320, y, "Extraordinary Beat X (c) 2009-2018 Zack Middleton", UI_CENTER|UI_SMALLFONT, color_white );

	UI_DrawString( 320, 459, "https://clover.moe/ebx/", UI_CENTER|UI_SMALLFONT, color_red );
}
