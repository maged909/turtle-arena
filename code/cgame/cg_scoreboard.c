...
#ifdef TA_SP // SP_SCOREBOARD
	CG_DrawString( scorex + (SB_RATING_WIDTH / 2) + 4*BIGCHAR_WIDTH, y, string, UI_RIGHT|UI_DROPSHADOW|UI_BIGFONT|UI_NOSCALE, color );
#else
...
#ifdef TA_SP // SP_SCOREBOARD
	CG_DrawString( namex - (SB_RATING_WIDTH / 2), y, pi->name, UI_LEFT|UI_DROPSHADOW|UI_BIGFONT|UI_NOSCALE, color );
#else
