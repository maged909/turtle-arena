...
static cvarTable_t		gameCvarTable[] = {
	...
	{ &g_fraglimit, "scorelimit", "1000", CVAR_SERVERINFO | CVAR_ARCHIVE | CVAR_NORESTART, 0, qtrue, RANGE_ALL },
#else
	...
	{ &g_quadfactor, "g_quadfactor", "2", 0, 0, qtrue, RANGE_ALL },
#else
	{ &g_quadfactor, "g_quadfactor", "3", 0, 0, qtrue, RANGE_ALL },
#endif
#ifdef TURTLEARENA
	{ &g_weaponRespawn, "g_weaponRespawn", "15", 0, 0, qtrue, RANGE_ALL },
...
#ifdef MISSIONPACK
#ifdef TURTLEARENA
	{ &g_obeliskHealth, "g_obeliskHealth", "1000", 0, 0, qfalse, RANGE_ALL },
	{ &g_obeliskRegenPeriod, "g_obeliskRegenPeriod", "1", 0, 0, qfalse, RANGE_ALL },
	{ &g_obeliskRegenAmount, "g_obeliskRegenAmount", "3", 0, 0, qfalse, RANGE_ALL },
#else
...
#ifdef TA_SP
	{ &g_savegameLoading, "savegame_loading", "0", 0, 0, qfalse, RANGE_ALL },
	{ &g_savegameFilename, "savegame_filename", "", 0, 0, qfalse, RANGE_ALL },
	{ &g_spSaveData, "g_spSaveData", "", CVAR_SYSTEMINFO, 0, qfalse, RANGE_ALL },
	{ &g_saveVersions, "g_saveVersions", BG_SAVE_VERSIONS, CVAR_ROM, 0, qfalse, RANGE_ALL },
	{ &g_saveFilename, "g_saveFilename", "", CVAR_SERVERINFO, 0, qfalse, RANGE_ALL },
	{ &g_saveMapname, "g_saveMapname", "", CVAR_ROM, 0, qfalse, RANGE_ALL },
#endif
#ifdef TURTLEARENA // POWERS // PW_FLASHING
	{ &g_teleportFluxTime, "g_teleportFluxTime", "5", 0, 0, qfalse, RANGE_ALL },
#endif
#ifdef IOQ3ZTM // LASERTAG
